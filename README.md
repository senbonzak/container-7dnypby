...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7dnypby.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7dnypby.containers.anotherwebservice.com/
...
```
git clone git@github.com:senbonzak/container-7dnypby.git
cd container-7dnypby
```
...
```
docker attach container-7dnypby
```
